    ...
    laboratory: [
      ...
      },
      {
        ...
        publications: [
          {
            title:
              'Kazanov FM, Matveev EV, Ponomarev GV, Ivankov DN, Kazanov MD. (2024).<br>Analysis of the abundance and diversity of RNA secondary structure elements in RNA viruses using the RNAsselem Python package. <br><i>Scientific Reports</i>, 14:28587',
            description:
