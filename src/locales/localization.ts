    ...
    laboratory: [
      ...
      },
      {
        ...
        publications: [
          ...
          {
            title:
              'Weinstein JY, Martí-Gómez C, Lipsh-Sokolik R, Hoch SY, Liebermann D, Nevo R, Weissman H, Petrovich-Kopitman E, Margulies D, Ivankov D, McCandlish DM, Fleishman SJ. (2023). Designed active-site library reveals thousands of functional GFP variants. Nature Communications, 14:2890.',
            description:
          ...
          {
            title:
              'Egorova TV, Galkin II, Velyaev OA, Vassilieva SG, Savchenko IM, Loginov VA, Dzhenkova MA, Korshunova DS, Kozlova OS, Ivankov DN, Polikarpova AV. (2023). In-Frame Deletion of Dystrophin Exons 8–50 Results in DMD Phenotype. International Journal of Molecular Sciences, 24(11), 9117.',
            description:
          ...
          {
            title:
              'Pak MA, Markhieva KA, Novikova MS, Petrov DS, Vorobyev IS, Maksimova ES, Kondrashov FA, Ivankov DN. (2023). Using AlphaFold to predict the impact of single mutations on protein stability and function. PLOS ONE, 18(3), e0282689.',
            description:
          ...
          {
            title:
              'Pak MA, Dovidchenko NV, Sharma SM, Ivankov DN. (2023). New mega dataset combined with deep neural network makes a progress in predicting impact of mutation on protein stability.',
            description:
          ...
          {
            title:
              'Finkelstein AV, Bogatyreva NS, Ivankov DN, Garbuzynskiy SO. (2022). Protein folding problem: enigma, paradox, solution. Biophysical Reviews.',
            description:
          ...
          {
            title:
              'Zorin EM, Erazo CM, Ivankov DN. (2022). Composite mutations give an extra insight into epistasis.',
            description:
          ...
          {
            title:
              'Ivankov DN, Finkelstein AV. (2020). Solution of Levinthal’s Paradox and a Physical Theory of Protein Folding Times. Biomolecules, 10(2), 250.',
            description:
          ...
          {
            title:
              'Esteban LA, Lonishin LR, Bobrovskiy D, Leleytner G, Bogatyreva NS, Kondrashov FA, Ivankov DN. (2019). HypercubeME: two hundred million combinatorially complete datasets from a single experiment. Bioinformatics. ',
            description:
