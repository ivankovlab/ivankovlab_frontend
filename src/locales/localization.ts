    ...
    laboratory: [
      ...
      },
      {
        ...
        publications: [
          {
            title:
              'Kazanov FM, Matveev EV, Ponomarev GV, Ivankov DN, Kazanov MD. <br>Analysis of the abundance and diversity of RNA secondary structure elements in RNA viruses using the RNAsselem Python package. <br><i>Scientific Reports</i>, 2024, 14:28587',
            description:
          ...
          {
            title:
              'Zhegalova IV, Ulianov SV, Galitsyna AA, Pletenev IA, Tsoy OV, Luzhin AV, Vasiluev PA, Bulavko ES, Ivankov DN, Gavrilov AA, Khrameeva EE, Gelfand MS, Razin SV. <br>Convergent gene pairs restrict chromatin looping in <i>Dictyostelium discoideum</i>, acting as directional barriers for extrusion. <br><i>bioRxiv</i>, 2024, 2024.06.12.598618',
            description:
          ...
          {
            title:
              'Frolova D, Pak MA, Litvin A, Sharov I, Ivankov DN, Oseledets I. <br>MULAN: multimodal protein language model for sequence and structure encoding. <br><i>bioRxiv</i>, 2024, 2024.05.30.596565.',
            description:
          ...
          {
            title:
              'Bogatyreva NS, Finkelstein AV, Ivankov DN. <br>A pitfall of iterative Ψ-BLAST. <br><i>J. Mol. Biomed. Res.</i>, 2024, 1:1',
            description:
          ...
          {
            title:
              'Finkelstein AV, Ivankov DN. <br>Protein 3D structure identification by AlphaFold: a physics-based prediction or recognition using huge databases? <br><i>The Journal of Molecular Biology</i>, 2024, 6:3935',
            description:
              '',
          ...
          {
            title:
              'Melnik TN, Majorina MA, Vorobieva DE, Nagibina GS, Veselova VR, Glukhova KА, Pak MA, Ivankov DN, Uversky VN, Melnik BS. <br>Design of stable circular permutants of the GroEL chaperone apical domain. <br><i>Cell Communication and Signaling</i>, 2024, 22:90',
            description:
              '',
          ...
          {
            title:
              'Bulavko ES, Pak MA, Ivankov DN. <br><i>In silico</i> simulations reveal molecular mechanism of uranyl ion toxicity towards DNA-binding domain of PARP-1 protein. <br><i>Biomolecules</i>, 2023, 13:1269',
            description:
          ...
          {
            title:
              'Egorova TV, Galkin II, Velyaev OA, Vassilieva SG, Savchenko IM, Loginov VA, Dzhenkova MA, Korshunova DS, Kozlova OS, Ivankov DN, Polikarpova AV. <br>In-Frame Deletion of Dystrophin Exons 8–50 Results in DMD Phenotype. <br><i>International Journal of Molecular Sciences</i>, 2023, 24:9117.',
            description:
          ...
          {
            title:
              'Weinstein JY, Martí-Gómez C, Lipsh-Sokolik R, Hoch SY, Liebermann D, Nevo R, Weissman H, Petrovich-Kopitman E, Margulies D, Ivankov D, McCandlish DM, Fleishman SJ. <br>Designed active-site library reveals thousands of functional GFP variants. <br><i>Nature Communications</i>, 2023, 14:2890.',
            description:
          ...
          {
            title:
              'Finkelstein AV, Bogatyreva NS, Ivankov DN, Garbuzynskiy SO. <br>Clarification to "Protein folding problem: enigma, paradox, solution". <br><i>Biophysical Reviews</i>, 2023, 15:161',
            description:
              '',
          ...
          {
            title:
              'Pak MA, Markhieva KA, Novikova MS, Petrov DS, Vorobyev IS, Maksimova ES, Kondrashov FA, Ivankov DN. <br>Using AlphaFold to predict the impact of single mutations on protein stability and function. <br><i>PLOS ONE</i>, 2023, 18:e0282689.',
            description:
          ...
          {
            title:
              'Pak MA, Dovidchenko NV, Sharma SM, Ivankov DN. <br>New mega dataset combined with deep neural network makes a progress in predicting impact of mutation on protein stability. <br><i>bioRxiv</i>, 2023, ',
            description:
          ...
          {
            title:
              'Zorin EM, Erazo CM, Ivankov DN. <br>Composite mutations give an extra insight into epistasis. <br><i>bioRxiv</i>, 2022',
            description:
          ...
          {
            title:
              'Finkelstein AV, Bogatyreva NS, Ivankov DN, Garbuzynskiy SO. <br>Protein folding problem: enigma, paradox, solution. <br><i>Biophysical Reviews</i>, 2022',
            description:
          ...
          {
            title:
              'Pak MA, Ivankov DN. <br>Best templates outperform homology models in predicting the impact of mutations on protein stability. <br><i>Bioinformatics</i>, 2022, 38:4312–4320',
            description:
          ...
          {
            title:
              'Tsitrina AA, Krasylov IV, Maltsev DI, Andreichenko IN, Moskvina VS, Ivankov DN, Bulgakova EV, Nesterchuk M, Shashkovskaya V, Dashenkova NO, Khilya VP, Mikaelyan A, Kotelevtsev Y. <br>Inhibition of hyaluronan secretion by novel coumarin compounds and chitin synthesis inhibitors. <br><i>Glycobiology</i>, 2021, 31:959-974',
            description:
              '',
          ...
          {
            title:
              'Ivankov DN, Finkelstein AV. <br>Solution of Levinthal’s paradox and a physical theory of protein folding times. <br><i>Biomolecules</i>, 2020, 10:250',
            description:
          ...
          {
            title:
              'Esteban LA, Lonishin LR, Bobrovskiy D, Leleytner G, Bogatyreva NS, Kondrashov FA, Ivankov DN. <br>HypercubeME: two hundred million combinatorially complete datasets from a single experiment. <br><i>Bioinformatics</i>, 2019. ',
            description:
          ...
          {
            title:
              'Pokusaeva VO, Usmanova DR, Putintseva EV, Espinar L, Sarkisyan KS, Mishin AS, Bogatyreva NS, Ivankov DN, Akopyan AV, Avvakumov SYa, Povolotskaya IS, Filion GJ, Carey LB, Kondrashov FA. <br>An experimental assay of the interactions of amino acids from orthologous sequences shaping a complex fitness landscape. <br><i>PLoS Genetics</i>, 2019, 15:e1008079.',
            description:
