    ...
    laboratory: [
      ...
      },
      {
        ...
        publications: [
          ...
          {
            title:
              'Finkelstein AV, Bogatyreva NS, Ivankov DN, Garbuzynskiy SO. <br><a href="https://doi.org/10.1007/s12551-022-01000-1">Protein folding problem: enigma, paradox, solution</a> <br><i>Biophysical Reviews</i>, 2022',
            description:
          ...
          {
            title:
              'Esteban LA, Lonishin LR, Bobrovskiy D, Leleytner G, Bogatyreva NS, Kondrashov FA, Ivankov DN. <br><a href="https://doi.org/10.1093/bioinformatics/btz841">HypercubeME: two hundred million combinatorially complete datasets from a single experiment</a> <br><i>Bioinformatics</i>, 2019. ',
            description:
